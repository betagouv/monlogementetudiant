              ...
              <>
                ...
                <span className="fr-text--xs fr-mb-0 fr-text-mention--grey">
                  * Ces informations sont issues des données déclarées par les étudiants dans le cadre de l’enquête{' '}
                  ...
                  et retravaillées en fonction des profils “décohabitants” (n’habitant pas chez leurs parents) et “indépendants” (n'étant
                  pas ou peu aidés par leurs parents) des étudiants.” afin de donner des estimations de budget.
                </span>
              </>
            )}
          </>
