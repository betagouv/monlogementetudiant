 ...
 *
 * Monté dans la mise en page des widgets, il couvre toutes les intégrations. Le widget concerné se
 * lit dans l'URL de page enregistrée par Matomo (`/widget/<nom>`) ; le libellé de l'événement reste
 * le seul hostname du partenaire pour ne pas rompre l'historique du rapport.
 */
