 ...
 */
export async function findAvailableSlug<TSchema extends Record<string, unknown> = Record<string, never>>(
  baseSlug: string,
  database: PostgresJsDatabase<TSchema>,
  table: PgTable & { slug: PgColumn<ColumnBaseConfig<ColumnDataType, string>> },
): Promise<string> {
